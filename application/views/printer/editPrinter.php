                        ...
                        <div class="mb-3 col-lg-4 col-md-6 print_format_div_invoice">
                            <div class="form-group">
                                ...
                                <select name="browser_direct_print" id="browser_direct_print" class="select2 form-control">
                                    <option <?php echo isset($printer_->browser_direct_print) && $printer_->browser_direct_print == "Yes"?"":"selected" ?> value="No"><?php echo lang('no'); ?></option>
                                    <option <?php echo isset($printer_->browser_direct_print) && $printer_->browser_direct_print == "Yes"?"selected":"" ?> value="Yes"><?php echo lang('yes'); ?></option>
                                </select>

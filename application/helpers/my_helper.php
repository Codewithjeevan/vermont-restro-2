...
function isServiceAccess($user_id='',$company_id='',$service_type='') {
    ...
    //var_dump(str_rot13($company->languge_manifesto)=='fTfzfWnSWIR1');die;
    //if($service_type && $service_type =="fTzfWnSWR" && str_rot13($company->languge_manifesto) =="fTzfWnSWIR1" &&  file_exists(APPPATH.'controllers/Service.php')){
        if($service_type && $service_type =="fTzfWnSWR" && str_rot13($company->languge_manifesto)=='fTfzfWnSWIR1' &&  file_exists(APPPATH.'controllers/Service.php')){
